...
I built Sift’s end-to-end AI generation workflow, database architecture, and backend systems, connecting model orchestration, image processing, job management, storage, and review into the iOS product.
